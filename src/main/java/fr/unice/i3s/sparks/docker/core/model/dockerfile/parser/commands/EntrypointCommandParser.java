...
import fr.unice.i3s.sparks.docker.core.model.dockerfile.commands.ENTRYPointCommand;
import fr.unice.i3s.sparks.docker.core.model.dockerfile.parser.CommandParser;

import java.util.Arrays;
import java.util.Iterator;

public class EntrypointCommandParser implements CommandParser {
    @Override
    public Command parse(Iterator<String> iterator, String currentLine) {
        ...
        return new ENTRYPointCommand(body);
    }
}
